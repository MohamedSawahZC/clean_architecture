...
import 'package:imdb_project/data/repositroy/weather_repository.dart';
import 'package:imdb_project/domain/repository/base_weather_repository.dart';
import 'package:imdb_project/domain/usecases/get_weather_by_city.dart';
...
void main() async{
  ...
  await GetWeatherByCityName(baseWeatherRepository).execute("Cairo");
  runApp(const MyApp());
